...
define('CSTATUS_CONTACTS_ONLY', 6);
define('CSTATUS_WITHOUT_ASSIGNMENTS', 7);
//define('CSTATUS_LAST', CSTATUS_DEBT_COLLECTION);
define('CSTATUS_LAST', CSTATUS_WITHOUT_ASSIGNMENTS);
...
$CSTATUSES = array(
	...
	CSTATUS_CONTACTS_ONLY => array(
		'singularlabel' => trans('contacts only'),
		'plurallabel' => trans('contacts only'),
		'summarylabel' => trans('contacts only:<!summary>'),
		'img' => 'money.gif',
		'alias' => 'contactsonly'
	),
	CSTATUS_WITHOUT_ASSIGNMENTS => array(
		'singularlabel' => trans('without assignments'),
		'plurallabel' => trans('without assignments'),
		'summarylabel' => trans('without assignments:<!summary>'),
		'img' => 'money.gif',
		'alias' => 'withoutassignments'
	),
);
...
define('DOC_POST_IN', -15);
define('DOC_POST_OUT', -16);
define('DOC_COURT_IN', -17);
define('DOC_COURT_OUT', -18);
...
//    DOC_CMEMO     =>  trans('credit memo'), // nota korygujaca
    ...
    DOC_POST_IN		=> trans('post correspondence in'),
    DOC_POST_OUT	=> trans('post correspondence out'),
    DOC_COURT_IN	=> trans('court correspondence in'),
    DOC_COURT_OUT	=> trans('court correspondence out')
