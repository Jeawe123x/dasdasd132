...
$global_access_regexp = '^(copyrights|logout|chpasswd|calendar|persistentsetting|zipcode)$';
...
$access_table = array(
	...
	'timetable_readonly' => array(
		'label' => trans('timetable readonly'),
		'allow_regexp' => '^(event(list|info|print|search|note)|choosecustomer)$',
	),
	...
	'user_management_forbidden' => array(
        ...
        'ksiegowy' => array(
                'label' => "Dostep dla ksiegowego",
//                'allow_regexp' => '^(customerlist|customerinfo|invoice|print|optima\-export|optima\-export\-download)$',
                'allow_regexp' => '^(optima\-export|optima\-export\-download)$',
        ),
	'armaget' => array(
		'label' => "Dostep dla Armaget",
		'allow_regexp' => '^(customergrouplist|customersearch|customergroupinfo|customergroup|invoiceinfo|invoicelist|balanceadd|customercutoffstop|balancelist|netdevmap|customeredit|nodeinfo)$',
	),
        'bok' => array(
                'label' => "Dostep dla BOK",
                'allow_regexp' => '^(invoice|netdevmap|invoicenoteedit|billinglist|pluginlist)|((promotion|promotionschema)(list|edit|add|del|set|info))$',
        ),
        'monter' => array(
                'label' => "Dostep dla monterów",
		'allow_regexp' => '^(event(list|info|print|search|note)|choosecustomer)$',
        ),
	'wyszukiwanie' => array(
                'label' => "Szybkie wyszkiwanie",
		'allow_regexp' => '^(quicksearch)$',
        ),
	'no_access' => array(
