...
$insttypes = array('domek-ftth' => 'domek-ftth.fodt',
		   'blok-ftth'  => 'blok-ftth.fodt',
		   'blok-etth'  => 'blok-etth.fodt');

if (isset($insttypes[$document['installtype']])) { 
    $engine['template'] = $insttypes[$document['installtype']];
} else { $engine['template'] = 'domek-ftth.fodt'; };
